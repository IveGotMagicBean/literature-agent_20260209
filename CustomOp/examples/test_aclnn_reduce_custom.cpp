...
int main()
{
    ...
    int32_t axes=0;
    int32_t keepdims = 1;
    ret = aclnnReduceCustomGetWorkspaceSize(selfX,axes, keepdims, out, &workspaceSize, &executor);
    ...
    CHECK_RET(ret == ACL_SUCCESS, LOG_PRINT("aclnnReduceCustom failed. ERROR: %d\n", ret); return ret);
